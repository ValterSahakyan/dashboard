                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal"   action="{{ route('numbers.update', $number->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" value="{{ $number->title }}" type="text" name="title" placeholder="Title">
                                                        @if ($errors->has('title'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control {{ $errors->has('percent') ? ' is-invalid' : '' }}" value="{{$number->percent}}" name="percent"/>
