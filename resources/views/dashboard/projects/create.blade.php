                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <textarea id="disease_contagion" class="form-control @error('disease_contagion') is-invalid @enderror"
                                                         ...
                                                         >{{old('disease_contagion')}}</textarea>
                                                        @if ($errors->has('disease_contagion'))
                                                            <span class="invalid-feedback">{{ $errors->first('contagion') }}</span>
                                                        @endif
                                                    </div>
                                                    <div class="col-md-3">
                                                        <textarea id="disease_mortality" class="form-control @error('disease_mortality') is-invalid @enderror"
                                                         ...
                                                         >{{old('disease_mortality')}}</textarea>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="collaboration_id" id="collaboration_id">
                                                            ...
                                                            @if($collaboration->id == old('collaboration_id'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control {{ $errors->has('request_title') ? ' is-invalid' : '' }}" id="request_title" value="{{ old('request_title') }}" type="text" name="request_title" placeholder="Request Title">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         <textarea id="request_sub_title" class="form-control @error('request_sub_title') is-invalid @enderror"
                                                                   ...
                                                                   placeholder="Sub Title"
                                                         >{{old('request_sub_title')}}</textarea>
                                                ...
                                                <div class="form-group row pt-3 pb-5">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="file" class="form-control file-input" type="file" name="file">
                                                    </div>
                                                </div>
