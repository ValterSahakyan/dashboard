    ...
    <div class="container-fluid">
        <div class="fade-in">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header"><h4>Edit Career</h4></div>
                        <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" value="{{ $career->title }}" type="text" name="title" placeholder="Title">
                                                        @if ($errors->has('title'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="date" class="form-control {{ $errors->has('deadline') ? ' is-invalid' : '' }}" value="{{$career->deadline}}" name="deadline"/>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control {{ $errors->has('location') ? ' is-invalid' : '' }}" id="location" value="{{ $career->location }}" type="text" name="location" placeholder="Location">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control {{ $errors->has('level') ? ' is-invalid' : '' }}" name="level">
                                                            ...
                                                            <option value="intern" {{ $career->level == 'intern' ? 'selected' : '' }}>Intern</option>
                                                            <option value="junior" {{ $career->level == 'junior' ? 'selected' : '' }}>Junior</option>
                                                            <option value="middle" {{ $career->level == 'middle' ? 'selected' : '' }}>Middle</option>
                                                            <option value="senior" {{ $career->level == 'senior' ? 'selected' : '' }}>Senior</option>
                                                            <option value="lead" {{ $career->level == 'lead' ? 'selected' : '' }}>Lead</option>
                                                        </select>
                                                        @if ($errors->has('level'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control {{ $errors->has('term') ? ' is-invalid' : '' }}" name="term">
                                                            ...
                                                            <option value="full_time" {{ $career->term == 'full_time' ? 'selected' : '' }}>Full Time</option>
                                                            <option value="part_time" {{ $career->term == 'part_time' ? 'selected' : '' }}>Part Time</option>
                                                        </select>
                                                        @if ($errors->has('term'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         ...
                                                         >{{$career->qualifications}}</textarea>
