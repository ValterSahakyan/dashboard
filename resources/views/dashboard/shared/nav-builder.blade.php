...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/denovo-icon.svg') }}" width="118" height="46" alt="Denovo Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/denovo-icon.png') }}" width="118" height="46" alt="Denovo Logo">
        </div>
