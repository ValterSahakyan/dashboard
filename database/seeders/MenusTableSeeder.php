...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $this->insertLink('user,admin', 'Team Members', '/team-members', 'cil-user-follow');
        $this->insertLink('user,admin', 'Technology', '/technologies', 'cil-cog');
        $this->insertLink('user,admin', 'Projects', '/projects', 'cil-puzzle');
        $this->insertLink('user,admin', 'Careers', '/careers', 'cil-vector');
        $this->insertLink('user,admin', 'Posts', '/posts', 'cil-newspaper');
        $this->insertLink('user,admin', 'Messages', '/messages', 'cil-chat-bubble');
        $this->insertLink('user,admin', 'The Numbers', '/numbers', 'cil-list-numbered');
        $this->insertLink('user,admin', 'Collaborations', '/collaborations', 'cil-apps');
        $this->insertLink('user,admin', 'Data Requests', '/data-requests', 'cil-request');
